          ...
          <div className="flex-1 max-w-4xl mx-auto w-full p-4 lg:p-8">
            ...
            <div className="mt-8 mb-4 flex justify-between items-center">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-cyan-600 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-cyan-700 transition-colors"
              >
