      ...
      <footer className="bg-gray-800 border-t border-gray-700 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <p className="text-gray-400">© 2026 Khushi Jain. All rights reserved.</p>
            <button
            ...
            >
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <textarea
                    className="w-full p-2 rounded-lg bg-gray-700 border border-gray-600 focus:border-cyan-500 focus:ring focus:ring-cyan-500 focus:ring-opacity-50"
                    rows={3}
                  />
                </div>
